...
export const ArrowPathIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.664 0l3.18-3.185m-3.181-4.992h-4.992m4.992 0v4.992m0 0l-3.182-3.182a8.25 8.25 0 00-11.664 0l-3.182 3.182" />
    </svg>
);

export const ShieldExclamationIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.468 1.952c.92-.92 2.376-.92 3.296 0l6.25 6.25c.92.92.92 2.376 0 3.296L13.046 22.05c-.92.92-2.376.92-3.296 0L3.498 15.8c-.92-.92-.92-2.376 0-3.296l6.25-6.25z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 15.75h.008v.008H12v-.008zm0-6v3.75" />
    </svg>
);
...
export const ServerIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 17.25v-.228a4.5 4.5 0 00-.12-1.03l-2.268-9.64a3.375 3.375 0 00-3.285-2.82H8.934a3.375 3.375 0 00-3.285 2.82l-2.268 9.64a4.5 4.5 0 00-.12 1.03v.228m15.36 0A2.25 2.25 0 0118.75 19.5h-13.5a2.25 2.25 0 01-2.25-2.25m15.36 0v-3.375c0-.621-.504-1.125-1.125-1.125h-13.5c-.621 0-1.125.504-1.125 1.125v3.375" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6.375h.008v.008h-.008v-.008z" />
    </svg>
);
